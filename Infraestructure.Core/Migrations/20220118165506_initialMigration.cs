        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdTypePermission = table.Column<int>(nullable: false),
                    TypePermissionIdTypePermission = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Permission", x => x.IdPermission);
                    table.ForeignKey(
                        name: "FK_Permission_TypePermission_TypePermissionIdTypePermission",
                        column: x => x.TypePermissionIdTypePermission,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permission_TypePermissionIdTypePermission",
                schema: "Security",
                table: "Permission",
                column: "TypePermissionIdTypePermission");
